namespace CG.Blue.Data.InMemory.Factories;

/// <summary>
/// This class is an in-memory design time factory for the <see cref="BlueDbContext"/>
/// data-context type.
/// </summary>
internal class BlueDbContextDesignTimeFactory : DesignTimeDbContextFactory<BlueDbContext>
{
    // *******************************************************************
    // Protected methods.
    // *******************************************************************
    ...
    protected override void OnConfigureDataContextOptions(
        DbContextOptionsBuilder<BlueDbContext> optionsBuilder,
